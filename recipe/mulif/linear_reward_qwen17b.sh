...
python3 -m verl.trainer.main_ppo \
    ...
    +reward_model.reward_kwargs.gii_weight=0.2 \
    +reward_model.reward_kwargs.via_weight=0.2 \
    trainer.critic_warmup=0.0 \
    trainer.logger=['console','wandb'] \
    trainer.project_name='MulIF' \
    trainer.experiment_name='linearR_gii_via_0.2_qwen17b' \
    ...
    trainer.total_training_steps=200 > log/linearR_gii_via_0.2_qwen17b.log
