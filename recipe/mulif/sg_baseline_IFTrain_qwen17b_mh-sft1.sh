...
n_gpus_per_node=2
MODEL_PATH=$HF_CACHE_DIR/qwen17b-mh-sft1
...
python3 -m verl.trainer.main_ppo \
    ...
    +reward_model.reward_kwargs.pairwise_alpha=0.0 \
    trainer.critic_warmup=0.0 \
    trainer.logger=['console','wandb'] \
    trainer.project_name='MulIF' \
    trainer.experiment_name='sg_baseline_IFTrain_qwen17b_mh-sft1' \
    ...
    trainer.total_training_steps=500 > log/sg_baseline_IFTrain_qwen17b_mh-sft1.log
