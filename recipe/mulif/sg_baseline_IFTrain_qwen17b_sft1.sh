...
n_gpus_per_node=4
MODEL_PATH=$HF_CACHE_DIR/single_hard_sft_qwen17b_s100_lr5e6_bz16_epoch2
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='sg_baseline_IFTrain_qwen17b_single_hard_sft_s100_lr5e6_bz16_epoch2' \
    ...
    trainer.total_training_steps=500 > log/sg_baseline_IFTrain_qwen17b_single_hard_sft_s100_lr5e6_bz16_epoch2.log
