...
export REWARDS_SCORE_MAX_WORKERS=32
...
python3 -m verl.trainer.main_ppo \
    ...
    +reward_model.reward_kwargs.gii_weight=0.5 \
    +reward_model.reward_kwargs.via_weight=0.5 \
    trainer.critic_warmup=0.0 \
    trainer.logger=['console','wandb'] \
    trainer.project_name='MulIF' \
    trainer.experiment_name='sampleR_w0.5_3c-12c_qwen17b' \
    ...
    trainer.total_training_steps=125 > log/sampleR_w0.5_3c-12c_qwen17b.log
