...
if [ -n "$AZURE_STORAGE_ROOT" ]; then
    ...
    DEFAULT_RUN_LOG_DIR="$AZURE_STORAGE_ROOT/logs/stage2_baseline_qwen7b_sft_mh_100"
    DEFAULT_WANDB_DIR="$AZURE_STORAGE_ROOT/wandb"
    DEFAULT_CKPT_DIR="$AZURE_STORAGE_ROOT/checkpoints/stage2_baseline_qwen7b_sft_mh_100"
    DEFAULT_PROFILE_DIR="$AZURE_STORAGE_ROOT/profile/stage2_baseline_qwen7b_sft_mh_100"
else
    ...
    DEFAULT_CKPT_DIR="$ROOT_DIR/checkpoints/MulIF/stage2_baseline_qwen7b_sft_mh_100"
    DEFAULT_PROFILE_DIR="$ROOT_DIR/outputs/profile/stage2_baseline_qwen7b_sft_mh_100"
fi
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='stage2_baseline_qwen7b_sft_mh_100' \
    ...
    trainer.total_training_steps=400 > "$RUN_LOG_DIR/stage2_baseline_qwen7b_sft_mh_100.log"
