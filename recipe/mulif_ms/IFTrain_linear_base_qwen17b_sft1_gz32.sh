...
if [ -n "$AZURE_STORAGE_ROOT" ]; then
    ...
    DEFAULT_RUN_LOG_DIR="$AZURE_STORAGE_ROOT/logs/IFTrain_linear_base_qwen17b_sft1_gz32"
    DEFAULT_WANDB_DIR="$AZURE_STORAGE_ROOT/wandb"
    DEFAULT_CKPT_DIR="$AZURE_STORAGE_ROOT/checkpoints/IFTrain_linear_base_qwen17b_sft1_gz32"
    DEFAULT_PROFILE_DIR="$AZURE_STORAGE_ROOT/profile/IFTrain_linear_base_qwen17b_sft1_gz32"
else
    ...
    DEFAULT_CKPT_DIR="$ROOT_DIR/checkpoints/IFTrain_linear_base_qwen17b_sft1_gz32"
    DEFAULT_PROFILE_DIR="$ROOT_DIR/outputs/profile/IFTrain_linear_base_qwen17b_sft1_gz32"
fi
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='IFTrain_linear_base_qwen17b_sft1_gz32' \
    ...
    trainer.total_training_steps=400 > "$RUN_LOG_DIR/IFTrain_linear_base_qwen17b_sft1_gz32.log"
