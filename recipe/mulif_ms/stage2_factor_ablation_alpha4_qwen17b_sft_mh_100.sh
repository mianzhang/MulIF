...
if [ -n "$AZURE_STORAGE_ROOT" ]; then
    ...
    DEFAULT_RUN_LOG_DIR="$AZURE_STORAGE_ROOT/logs/stage2_factor_ablation_alpha4_qwen17b_sft_mh_100"
    DEFAULT_WANDB_DIR="$AZURE_STORAGE_ROOT/wandb"
    DEFAULT_CKPT_DIR="$AZURE_STORAGE_ROOT/checkpoints/stage2_factor_ablation_alpha4_qwen17b_sft_mh_100"
    DEFAULT_PROFILE_DIR="$AZURE_STORAGE_ROOT/profile/stage2_factor_ablation_alpha4_qwen17b_sft_mh_100"
else
    ...
    DEFAULT_CKPT_DIR="$ROOT_DIR/checkpoints/MulIF/stage2_factor_ablation_alpha4_qwen17b_sft_mh_100"
    DEFAULT_PROFILE_DIR="$ROOT_DIR/outputs/profile/stage2_factor_ablation_alpha4_qwen17b_sft_mh_100"
fi
...
python3 -m verl.trainer.main_ppo \
    ...
    +reward_model.reward_kwargs.pairwise_alpha=4.0 \
    trainer.critic_warmup=0.0 \
    trainer.logger=['console','wandb'] \
    trainer.project_name='MulIF' \
    trainer.experiment_name='stage2_factor_ablation_alpha4_qwen17b_sft_mh_100' \
    ...
    trainer.total_training_steps=400 > "$RUN_LOG_DIR/stage2_factor_ablation_alpha4_qwen17b_sft_mh_100.log"
