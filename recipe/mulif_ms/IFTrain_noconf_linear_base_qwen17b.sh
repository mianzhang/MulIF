...
if [ -n "$AZURE_STORAGE_ROOT" ]; then
    ...
    DEFAULT_RUN_LOG_DIR="$AZURE_STORAGE_ROOT/logs/IFTrain_noconf_linear_base_qwen17b"
    DEFAULT_WANDB_DIR="$AZURE_STORAGE_ROOT/wandb"
    DEFAULT_CKPT_DIR="$AZURE_STORAGE_ROOT/checkpoints/IFTrain_noconf_linear_base_qwen17b"
    DEFAULT_PROFILE_DIR="$AZURE_STORAGE_ROOT/profile/IFTrain_noconf_linear_base_qwen17b"
else
    ...
    DEFAULT_CKPT_DIR="$ROOT_DIR/checkpoints/IFTrain_noconf_linear_base_qwen17b"
    DEFAULT_PROFILE_DIR="$ROOT_DIR/outputs/profile/IFTrain_noconf_linear_base_qwen17b"
fi
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='IFTrain_noconf_linear_base_qwen17b' \
    ...
    trainer.total_training_steps=500 > "$RUN_LOG_DIR/IFTrain_noconf_linear_base_qwen17b.log"
