...
if [ -n "$AZURE_STORAGE_ROOT" ]; then
    ...
    DEFAULT_RUN_LOG_DIR="$AZURE_STORAGE_ROOT/logs/rebuttal_SaR_qwen7b"
    DEFAULT_WANDB_DIR="$AZURE_STORAGE_ROOT/wandb"
    DEFAULT_CKPT_DIR="$AZURE_STORAGE_ROOT/checkpoints/rebuttal_SaR_qwen7b"
    DEFAULT_PROFILE_DIR="$AZURE_STORAGE_ROOT/profile/rebuttal_SaR_qwen7b"
else
    ...
    DEFAULT_CKPT_DIR="$ROOT_DIR/checkpoints/MulIF/rebuttal_SaR_qwen7b"
    DEFAULT_PROFILE_DIR="$ROOT_DIR/outputs/profile/rebuttal_SaR_qwen7b"
fi
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='rebuttal_SaR_qwen7b' \
    ...
    trainer.total_training_steps=400 > "$RUN_LOG_DIR/rebuttal_SaR_qwen7b.log"
