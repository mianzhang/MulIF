...
if [ -n "$AZURE_STORAGE_ROOT" ]; then
    ...
    DEFAULT_RUN_LOG_DIR="$AZURE_STORAGE_ROOT/logs/stage2_gz32_baseline_qwen17b"
    DEFAULT_WANDB_DIR="$AZURE_STORAGE_ROOT/wandb"
    DEFAULT_CKPT_DIR="$AZURE_STORAGE_ROOT/checkpoints/stage2_gz32_baseline_qwen17b"
    DEFAULT_PROFILE_DIR="$AZURE_STORAGE_ROOT/profile/stage2_gz32_baseline_qwen17b"
else
    ...
    DEFAULT_CKPT_DIR="$ROOT_DIR/checkpoints/MulIF/stage2_gz32_baseline_qwen17b"
    DEFAULT_PROFILE_DIR="$ROOT_DIR/outputs/profile/stage2_gz32_baseline_qwen17b"
fi
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='stage2_gz32_baseline_qwen17b' \
    ...
    trainer.total_training_steps=400 > "$RUN_LOG_DIR/stage2_gz32_baseline_qwen17b.log"
