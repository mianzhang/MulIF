...
if [ -n "$AZURE_STORAGE_ROOT" ]; then
    ...
    DEFAULT_RUN_LOG_DIR="$AZURE_STORAGE_ROOT/logs/sg_baseline_rule_qwen17b"
    DEFAULT_WANDB_DIR="$AZURE_STORAGE_ROOT/wandb"
    DEFAULT_CKPT_DIR="$AZURE_STORAGE_ROOT/checkpoints/sg_baseline_rule_qwen17b"
    DEFAULT_PROFILE_DIR="$AZURE_STORAGE_ROOT/profile/sg_baseline_rule_qwen17b"
else
    ...
    DEFAULT_CKPT_DIR="$ROOT_DIR/checkpoints/MulIF/sg_baseline_rule_qwen17b"
    DEFAULT_PROFILE_DIR="$ROOT_DIR/outputs/profile/sg_baseline_rule_qwen17b"
fi
...
python3 -m verl.trainer.main_ppo \
    ...
    +reward_model.reward_kwargs.weighted_inst_base_score=False \
    ...
    trainer.total_training_steps=150 > "$RUN_LOG_DIR/sg_baseline_rule_qwen17b.log"
