...
if [ -n "$AZURE_STORAGE_ROOT" ]; then
    ...
    DEFAULT_RUN_LOG_DIR="$AZURE_STORAGE_ROOT/logs/stage2_linear_base_qwen7b"
    DEFAULT_WANDB_DIR="$AZURE_STORAGE_ROOT/wandb"
    DEFAULT_CKPT_DIR="$AZURE_STORAGE_ROOT/checkpoints/stage2_linear_base_qwen7b"
    DEFAULT_PROFILE_DIR="$AZURE_STORAGE_ROOT/profile/stage2_linear_base_qwen7b"
else
    ...
    DEFAULT_CKPT_DIR="$ROOT_DIR/checkpoints/MulIF/stage2_linear_base_qwen7b"
    DEFAULT_PROFILE_DIR="$ROOT_DIR/outputs/profile/stage2_linear_base_qwen7b"
fi
...
n_gpus_per_node=8
MODEL_PATH=$HF_CACHE_DIR/Qwen/Qwen2.5-7B-Instruct
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='stage2_linear_base_qwen7b' \
    ...
    trainer.total_training_steps=400 > "$RUN_LOG_DIR/stage2_linear_base_qwen7b.log"
